...
var treeMenu = [
    { level:1, name:"宿舍用电信息管理"},
    { level:2, name:"宿舍用电信息列表", ico:"images/icon_default.gif",link:"listSushe.action"},
    { level:2, name:"添加宿舍", ico:"images/icon_default.gif",link:"sushe/save.jsp"},
            	
	{ level:1, name:"学生信息管理"},
	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"listStu.action"},
	{ level:2, name:"添加学生", ico:"images/icon_default.gif",link:"students/save.jsp"},
		
	{ level:1, name:"信息管理"},
	{ level:2, name:"公告管理", ico:"images/icon_default.gif",link:""},
	{ level:2, name:"系统邮件", ico:"images/icon_default.gif"},
	
	{ level:1, name:"更换密码", ico:"images/icon_default.gif",link:"users/changePw.jsp"},
];
</script>
<style>
* {
