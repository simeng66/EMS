			...
			<div id="mainPanel">
				...
				<div id="right">
					...
					<div id="user-name">
						...
						<span><input type="text" name="admin.userName" class="form-input"></span>
					</div>
					<div id="user-password">
						<span class="item">密&nbsp;&nbsp;&nbsp;码:</span>
						<span class="input"><input type="password" name="admin.userPw" class="form-input"></span>
					</div>
					<div id="button-group">
